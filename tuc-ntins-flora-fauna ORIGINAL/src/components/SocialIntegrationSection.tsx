  ...
  const socialLinks = [
    {
      platform: "Instagram",
      icon: Instagram,
      handle: "@tucatinsilvestre",
      url: "https://www.instagram.com/tucatinsilvestre?igsh=MWxiaTFkano5dXN1OA==",
    ...
    },
    {
      platform: "Instagram",
      icon: Instagram,
      handle: "@Roraima Silvestre",
      url: "https://www.instagram.com/roraimasilvestre?igsh=ZWtwbnAzN29xMTEx",
    ...
    },
    {
      platform: "Instagram",
      icon: Instagram,
      handle: "@Sertão_silvestre",
      url: "https://www.instagram.com/sertao_silvestre?igsh=MTRiMzU2bWxnbzRnYg==",
